...
export default async function LandingHero() {
  ...
  return (
    <section className="section p-8 font-georgian" aria-labelledby="hero-title">
      <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
        <div>
          ...
          <h1
            id="hero-title"
            className="mt-6 text-3xl font-bold leading-tight text-slate-900 md:text-4xl lg:text-5xl"
          >
            {t("heroTitle")}
          </h1>
          ...
          <ul className="mt-10 space-y-3">
            {[t("heroBullet1"), t("heroBullet2"), t("heroBullet3")].map(
              (item) => (
                ...
                >
                  <span
                    className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-emerald-100 text-emerald-600 text-sm font-bold"
                    aria-hidden
                  >
                    ✓
                  </span>
        ...
        >
          ...
          <div className="mt-4 space-y-3">
            <div className="flex items-center gap-3 rounded-xl border-2 border-blue-500 bg-blue-50/80 p-4">
              <span
                className="h-5 w-5 shrink-0 rounded-full border-2 border-blue-500 bg-white"
                aria-hidden
              />
              {t("mockAnswer1")}
            </div>
